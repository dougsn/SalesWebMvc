...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed() // Metodo para popular o banco de dados
        {
            // Validando para saber se já existe algum dado na base de dados com o .Any()
            if (_context.Department.Any() || _context.Sellers.Any() || _context.SalesRecord.Any())
            {
                return; // Verificando se as tabelas já foram populadas, se sim, ele interrompe a execução
            }

            // Instanciando os objetos para depois inserir na base de dados.
            ...
            // Efetuando o save no banco de dados efetivamente.
